...
const ArticleScreen = ({ route }) => {
    ...
    return (
        <SafeAreaView style={{ flex: 1, marginTop: statusBarHeight, backgroundColor: '#fff' }}>
            ...
            <ScrollView>
                ...
                <View className=" px-4 bg-white h-full ">
                    <Image
                        ...
                        style={{ width: '100%', height: 200, borderRadius: 2, marginBottom: 10 }}
                        resizeMode="cover"
                    />
                    ...
                    <View style={{ flexDirection: 'row', flexWrap: 'wrap', }}>
                        ...
                        <View>
                            <Text style={{ fontSize: 20, fontFamily: 'PlusJakartaSans-Bold', }}>
                                {blog_title}
                            </Text>
                        ...
                        <View>
                            {sections.map((section, index) => (
                                <View key={index} className="space-y-4" >
                                    <Text style={{ fontSize: 20, fontFamily: 'PlusJakartaSans-Bold', }}>{section.title}</Text>
                                    <Text style={{ fontSize: 16, color: '#666', }}>{section.content}</Text>
                                </View>
                            ))}

                        </View>
                        <View style={{ flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', marginBottom:20 }}>
                            <Text style={{ fontFamily: 'PlusJakartaSans-Bold', fontSize: 14 }}>
