        ...
        <View className=" h-auto bg-white w-full mt-20 border-2 border-gray-200/40 p-4 rounded-lg  shadow-lg shadow-black ">
            ...
            <View>
                <TouchableOpacity>
                      ...
                      <View className=" border-2 border-black/5 bg-blue-800 shadow-sm shadow-black/5" style={{  borderRadius:5, paddingVertical: 5, paddingHorizontal: 10, flexDirection: 'row', justifyContent: 'center', alignItems: 'center', marginTop: 10, 
                       }}>
