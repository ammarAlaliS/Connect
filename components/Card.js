...
import { setShowInitialCard } from "../globalState/travelSlice";
...
const Card = () => {
  ...
  return (
    <View
      className="bg-white px-6 py-2 border-2 border-gray-400/40 shadow-lg shadow-black"
      style={{ width: "100%" }}
    >
          ...
          <View className=" flex-row items-center space-x-2">
            <TouchableOpacity>
              <View
                ...
                onTouchEnd={() => {
                  dispatch(setShowInitialCard(false));
                }}
              >
                <Text
                  style={{
